# Awesome Ionic 2+ Components with stars
...
* [NgTranslate](https://github.com/ngx-translate/core) ⭐ 4,660 | 🐛 98 | 🌐 TypeScript | 📅 2026-07-20 ![](angular.png)
* [angular-I10n](https://github.com/robisim74/angular-l10n) ⭐ 375 | 🐛 2 | 🌐 TypeScript | 📅 2025-06-18 ![](angular.png)

### Menu, Tabs

* [Multi Level Sidemenu](https://github.com/sebaferreras/Ionic2-MultiLevelSideMenu) ⭐ 135 | 🐛 5 | 🌐 TypeScript | 📅 2018-10-12 ![](ionic.png)
* [Scrollabel Tabs](https://github.com/SinoThomas/Ionic2-ScrollableTabs) ⭐ 73 | 🐛 8 | 🌐 TypeScript | 📅 2017-04-26 ![](ionic.png)
* [Circular Tabs](https://github.com/SinoThomas/Ionic2-CircularTabs) ⭐ 43 | 🐛 0 | 🌐 TypeScript | 📅 2017-11-28 ![](ionic.png)
* [Fab Toolbar](https://github.com/ekhmoi/fab-toolbar) ⭐ 31 | 🐛 0 | 🌐 TypeScript | 📅 2023-07-18 ![](ionic.png)
* [Popover Sidemenu](https://github.com/philipbrack/ionic2-menu-alternative-popover) ⭐ 2 | 🐛 0 | 🌐 HTML | 📅 2016-10-30 ![](ionic.png)

### Form / Input

* [Dynamic Forms](https://github.com/udos86/ng2-dynamic-forms/) ⭐ 1,309 | 🐛 128 | 🌐 TypeScript | 📅 2024-02-06 ![](angular.png)
...
* [Form Builder](https://github.com/rohitg7/ionic2-form-builder) ⭐ 4 | 🐛 0 | 🌐 TypeScript | 📅 2016-11-28 ![](ionic.png)
...
* **Calendar**
  * [Calendar](https://github.com/mattlewis92/angular-calendar) ⭐ 2,824 | 🐛 96 | 🌐 TypeScript | 📅 2026-04-08 ![](angular.png) (very powerful)
...
* [Image Loader](https://github.com/zyramedia/ionic-image-loader) ⭐ 432 | 🐛 79 | 🌐 TypeScript | 📅 2026-08-05 ![](ionic.png)
...
* [Image Fallback](https://github.com/VadimDez/ng2-img-fallback) ⭐ 82 | 🐛 5 | 🌐 TypeScript | 📅 2024-05-20 ![](angular.png)
...
* [Simple Audioplayer](https://github.com/arielfaur/ionic-audio) ⭐ 320 | 🐛 68 | 🌐 CSS | 📅 2018-03-12 ![](ionic.png)
* [Video Editor](https://github.com/rossmartin/video-editor-ionic2) ⭐ 70 | 🐛 5 | 🌐 JavaScript | 📅 2016-05-26 ![](ionic.png)
* [Audio Recorder](https://github.com/tracktunes/ionic-recorder) ![](ionic.png)

### Keyboards

* [Digit Keyboard](https://github.com/skol-pro/ion-digit-keyboard-v2) ⭐ 92 | 🐛 20 | 🌐 TypeScript | 📅 2026-06-16 ![](ionic.png)
* [Pincode Keyboard](https://github.com/HsuanXyz/ionic2-pincode-input) ⭐ 57 | 🐛 5 | 🌐 TypeScript | 📅 2019-05-02 ![](ionic.png)

### Dialog

* [Dialogbox with Counter](https://github.com/HsuanXyz/ionic2-extend-alert) ⭐ 10 | 🐛 0 | 🌐 CSS | 📅 2017-03-02 ![](ionic.png)

### Frames

* [ng Lightning (for Salesforce Apps)](https://github.com/ng-lightning/ng-lightning) ⭐ 915 | 🐛 49 | 🌐 TypeScript | 📅 2024-07-03 ![](angular.png)

### Picker

* [Multi Picker](https://github.com/raychenfj/ion-multi-picker) ⚠️ Archived ![](ionic.png)
...
* [Auth with Token](https://github.com/neroniaky/angular2-token) ⭐ 368 | 🐛 49 | 🌐 TypeScript | 📅 2024-01-22 ![](ionic.png) ![](angular.png)
...
* [Firebase Rest API](https://github.com/angular/angularfire2) ⭐ 7,808 | 🐛 202 | 🌐 TypeScript | 📅 2026-08-13 ![](angular.png)
* [JSON Web Token (JWT)](https://github.com/auth0/angular2-jwt) ⭐ 2,627 | 🐛 15 | 🌐 TypeScript | 📅 2026-08-08 ![](angular.png) ![](ionic.png)
...
* [Amazon - AWS](https://github.com/vbudilov/aws-cognito-ionic2) ⭐ 65 | 🐛 2 | 🌐 JavaScript | 📅 2018-05-25 ![](ionic.png)
* [PouchDB](https://github.com/ashteya/ionic2-tutorial-pouchdb) ⭐ 55 | 🐛 5 | 🌐 TypeScript | 📅 2017-05-08 ![](ionic.png)
* [Wordpress](https://github.com/scottopolis/ionic2-wp-api) ⭐ 39 | 🐛 0 | 🌐 JavaScript | 📅 2017-05-25 ![](ionic.png)
* [SQL Interface](https://github.com/seand88/ionic2-sql-interface) ⭐ 18 | 🐛 1 | 🌐 TypeScript | 📅 2016-11-07 ![](ionic.png)
* [Codepush & Ionic2](https://github.com/ksachdeva/ionic2-code-push) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2016-08-29 ![](ionic.png)
* [Microsoft Emotion API](https://github.com/lazyc97/emo-clash) ⭐ 0 | 🐛 3 | 🌐 HTML | 📅 2017-10-15 ![](ionic.png)
* [Google Maps](https://angular-maps.com/) ![](angular.png)
* [Github Auth](https://auth0.com/authenticate/ionic2/github) ![](ionic.png)

### Pipe

* [Pipe Collection (around 20 pipes for strings etc)](https://github.com/danrevah/ngx-pipes) ⭐ 1,571 | 🐛 48 | 🌐 TypeScript | 📅 2024-01-10 ![](angular.png)
* [Filtering Array](https://github.com/VadimDez/ng2-filter-pipe) ⭐ 140 | 🐛 36 | 🌐 TypeScript | 📅 2024-09-08 ![](angular.png)

## Boilerplate/Demo Apps

* [Ionic 2 Advanced Components](https://github.com/yannbf/ionic2-components) ⭐ 1,668 | 🐛 23 | 🌐 TypeScript | 📅 2025-11-27 ![](ionic.png)
* [Ionic 2](https://github.com/marcoturi/ionic2-boilerplate) ⚠️ Archived ![](ionic.png)
* [ORC Scan App](https://github.com/matiastucci/ionic-ocr-example) ⭐ 261 | 🐛 3 | 🌐 JavaScript | 📅 2016-12-21 ![](ionic.png) based on [ocrad.js](https://github.com/antimatter15/ocrad.js) ⭐ 3,519 | 🐛 28 | 🌐 JavaScript | 📅 2020-09-02
...
* [Fullscreen Content](https://github.com/sebaferreras/Ionic2-FullscreenContent) ⭐ 21 | 🐛 0 | 🌐 TypeScript | 📅 2018-08-04 ![](ionic.png)
* [Card Layout](https://github.com/joshuamorony/ionic2-card-layout) ⭐ 19 | 🐛 0 | 🌐 CSS | 📅 2017-06-19 ![](ionic.png)
* [Redux](https://github.com/janjarfalk/ionic2-angular2-ts-redux-boilerplate) ![](ionic.png)

## Build Stuff

* [Ionic App Script](https://github.com/driftyco/ionic-app-scripts) ⚠️ Archived ![](ionic.png)
...
* [Restaurant App](https://github.com/srehanuddin/Ionic2-ResturantApp) ⭐ 94 | 🐛 5 | 🌐 JavaScript | 📅 2023-07-31 ![](ionic.png)
* [Geo Fence](https://github.com/tsubik/ionic2-geofence) ⭐ 91 | 🐛 5 | 🌐 CSS | 📅 2018-03-21 ![](ionic.png)
* [Inoffical "Myki" App](https://github.com/longzheng/mypal-ionic) ⚠️ Archived ![](ionic.png)
* [YouTube](https://github.com/hughred22/Ionic2-Angular2-YouTube-Channel-App) ⭐ 44 | 🐛 6 | 🌐 CSS | 📅 2016-12-01 ![](ionic.png)
* [Indexed Scroll Examples](https://github.com/HsuanXyz/ionic2-indexed-scroll) ⭐ 40 | 🐛 2 | 🌐 TypeScript | 📅 2017-08-28 ![](ionic.png)
* [Firebase Chat App](https://github.com/ionic2blueprints/firebase-chat) ⭐ 36 | 🐛 2 | 🌐 TypeScript | 📅 2017-03-13 ![](ionic.png)
* [Media Player](https://github.com/ionic2blueprints/media-player) ⭐ 30 | 🐛 1 | 🌐 TypeScript | 📅 2017-04-03 ![](ionic.png)
* [Social App](https://github.com/ionic2blueprints/social-app) ⭐ 27 | 🐛 0 | 🌐 TypeScript | 📅 2016-09-28 ![](ionic.png)
* [mHUD - Car App](https://github.com/paulcockrell/mHUD) ⭐ 26 | 🐛 0 | 🌐 CSS | 📅 2017-02-18 ![](ionic.png) Speed tracking
* [Ecommerce App](https://github.com/ionic2blueprints/ionic2-marketcloud) ⭐ 26 | 🐛 5 | 🌐 TypeScript | 📅 2023-10-10 ![](ionic.png)
* [Wordpress Client](https://github.com/ionic2blueprints/ionic2-wp-client) ⭐ 20 | 🐛 1 | 🌐 TypeScript | 📅 2016-08-31 ![](ionic.png)
* [Stock Tracking App](https://github.com/ionic2blueprints/ionic2-stockmarket) ⭐ 18 | 🐛 2 | 🌐 TypeScript | 📅 2023-10-10 ![](ionic.png)
* [Conference App based on Lanyrd API](https://github.com/ionic2blueprints/conference-app) ⭐ 7 | 🐛 0 | 🌐 TypeScript | 📅 2016-08-31 ![](ionic.png)
* [Freshlypressed API App](https://github.com/rajayogan/ionic2-freshlypressed) ⭐ 3 | 🐛 0 | 🌐 JavaScript | 📅 2016-02-28 ![](ionic.png)
* [App Evangelist](https://github.com/fishme/app-evangelist.com) ⭐ 0 | 🐛 0 | 🌐 TypeScript | 📅 2017-08-20 my own Homepage/App with [getdirectus.com](getdirectus.com)  (in progress) ![](ionic.png)
